...
wk.add({
  ...
  { ",g",        "<cmd>vsp<cr>",                                         desc = "vertical split window" },
  { ",h",        "<C-w>h",                                               desc = "go to the window left" },
  { ",j",        "<C-w>j",                                               desc = "go to the window below" },
  { ",k",        "<C-w>k",                                               desc = "go to the window up" },
  { ",l",        "<C-w>l",                                               desc = "go to the window right" },
  { ",m",        "<cmd>only<cr>",                                        desc = "delete other window" },
  { ",n",        "<cmd>AerialToggle!<cr>",                               desc = "toggle navigator" },
